        ...
        <div className="route-contact">
            ...
            <div className="contact-wrapper">
                <div className="col contact-detail">
                    ...
                    <div className="contact-email">{TranslateService.translate('forma.common.label.email')}&nbsp;forma@formamuebles.com</div>
                </div>
                <div className="col contact-detail">
                    ...
                    <div className="contact-opening-hours">{TranslateService.translate('forma.showroom.mainoffice.workinghours')}</div>
                    <div className="contact-email">{TranslateService.translate('forma.common.label.email')}gufina@formamuebles.com</div>
                </div>
            </div>
        </div>
    );
